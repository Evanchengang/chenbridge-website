...
if(splash){
  ...
  if(splashSeen){
    ...
    var splashTimer=setTimeout(function(){hideSplash();},3200);function hideSplash(){clearTimeout(splashTimer);splash.classList.add('hide');setTimeout(function(){splash.style.display='none';},800);}setTimeout(function(){setTimeout(function(){document.addEventListener('mousemove',hideSplash,{once:true});},300);},300);
  }
}
